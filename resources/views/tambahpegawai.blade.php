          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tambah Data Pegawai Kelurahan</h4>
                    <form action="/insertdata" method="POST" enctype="multipart/form-data" class="forms-sample">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputName1">NIP</label>
                            <input type="text"  name="NIP" class="form-control" id="exampleInputName1" placeholder="NIP">
                          </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text"  name="Alamat" class="form-control" id="exampleInputPassword4" placeholder="alamat">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="Jabatan" class="form-control" id="exampleInputName1" placeholder="jabatan">
                      </div>
                      <!-- <div class="form-group">
