          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <!-- <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Data Pegawai Kelurahan</h4>
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="container">
                  ...
                  <!-- <div class="card-body"> -->
                    <h4 class="card-title">Data Karyawan Kelurahan</h4>
                    <!-- <p class="card-description"></code> -->
                        <a href="/tambahdata"  class="btn btn-success mr-2" >Tambah data Pegawai</a>
                    </p>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                             <a href="/tampilkandata/{{ $row->id }}"  class="btn btn-primary mr-2">edit</a>
